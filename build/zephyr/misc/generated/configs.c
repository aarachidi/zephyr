...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_SIFIVE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WDT_SIFIVE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_SIFIVE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PWM_SIFIVE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ARTYA7, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_RISCV_E310ARTYA7, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_RISCV_PRIVILEGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_RISCV_E310ARTYA7, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIFIVE_SPI_0_ROM, 1);
